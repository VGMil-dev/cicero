...
- **[Decisiones de Diseño](./decisiones)**: Justificación técnica del uso de PWA, Transformers.js, y la eliminación de un backend tradicional.
...
2.  **Transmripción Literal**: Procesamiento instantáneo en un Web Worker del navegador utilizando **Transformers.js** y el modelo **CrisperWhisper** para obtener el texto completo, incluyendo tartamudeos y muletillas.
